...
; CHECK: define weak_odr dso_local i64 @_ZTS14other_function(i32 addrspace(4)* %0) !dbg !11 {
...
; CHECK: %3 = call i64 @_ZTS14other_function(i32 addrspace(4)* %2), !dbg !15
  ret void
}

; CHECK: define weak_odr dso_local void @_ZTS14example_kernel_with_offset([3 x i32]* byref([3 x i32]) %0) !dbg !16 {
; CHECK:   %3 = call i64 @_ZTS14other_function(i32 addrspace(4)* %2), !dbg !17
