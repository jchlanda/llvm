...
; CHECK: define weak_odr dso_local i64 @_ZTS14other_function(i32 addrspace(4)* %0) {
...
; CHECK: %2 = getelementptr inbounds i32, i32 addrspace(4)* %0, i64 2
  ...
  %5 = tail call i32 addrspace(4)* @llvm.amdgcn.implicit.offset()
; CHECK-NOT: tail call i32 addrspace(4)* @llvm.amdgcn.implicit.offset()
  %6 = getelementptr inbounds i32, i32 addrspace(4)* %5, i64 2
; CHECK: %5 = getelementptr inbounds i32, i32 addrspace(4)* %0, i64 2
...
entry:
; CHECK: %0 = alloca [3 x i32], align 4, addrspace(4)
...
; CHECK: %3 = call i64 @_ZTS14other_function(i32 addrspace(4)* %2)
  %1 = call i64 @_ZTS14other_function()
; CHECK: %4 = call i64 @_ZTS14other_function(i32 addrspace(4)* %2)
  ret void
}
